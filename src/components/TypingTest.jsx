...
const textData = `The project I'll be making will allow users to see concerts that are happening in their city that night, and then make a Spotify playlist based on the ones they're interested in.`;
...
function TypingTest() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#f7f7f7] py-20 px-10 space-y-10">
      ...
      <div className="h-4/5 w-5/6 bg-white rounded-2xl p-10 overflow-y-auto text-4xl leading-loose text-gray-500 font-mono shadow-lg">
        {textData.split("").map((char, i) => (
          <span
            ...
            className={`px-1 py-1 mx-0.5 rounded 
                ...
                ${
                  i === state.curIndex
                    ? "border-b-4 border-purple-400 animate-blink text-purple-400"
                    : ""
                }
                `}
          >
